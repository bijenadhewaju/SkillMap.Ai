    ...
    <div className="d-flex flex-column min-vh-100">
      ...
      <header id="home" className="pt-5 pb-5 mt-5">
        <div className="container text-center py-5 mt-4">
          <h1 className="display-3 fw-bold text-brand mb-4">Map Your Future in Tech</h1>
      ...
      <section id="features" className="py-5 bg-soft">
        <div className="container py-4">
          <div className="text-center mb-5">
            <h2 className="fw-bold text-brand">Intelligent Platform Features</h2>
      ...
      <section id="workflow" className="py-5">
        <div className="container py-4">
          <div className="text-center mb-5">
            <h2 className="fw-bold text-brand">How It Works</h2>
            <p className="text-secondary">Your journey from beginner to hired in four simple steps.</p>
          </div>
          <div className="row text-center g-4">
            <div className="col-md-3 mb-4">
              <h3 className="text-brand fw-bold display-6 mb-3">01.</h3>
              <h6 className="fw-bold text-dark">Create Profile</h6>
              <p className="text-secondary small mt-2">Enter your education and technical skills.</p>
            </div>
            <div className="col-md-3 mb-4">
              <h3 className="text-brand fw-bold display-6 mb-3">02.</h3>
              <h6 className="fw-bold text-dark">Select Career</h6>
              <p className="text-secondary small mt-2">Choose your target role in the industry.</p>
            </div>
            <div className="col-md-3 mb-4">
              <h3 className="text-brand fw-bold display-6 mb-3">03.</h3>
              <h6 className="fw-bold text-dark">AI Analysis</h6>
              <p className="text-secondary small mt-2">Identify your skill gaps instantly.</p>
            </div>
            <div className="col-md-3 mb-4">
              <h3 className="text-brand fw-bold display-6 mb-3">04.</h3>
              <h6 className="fw-bold text-dark">Start Learning</h6>
